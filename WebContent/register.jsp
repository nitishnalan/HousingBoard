...
<form name="regform" action="/HousingBoard/registerUser" method="post" onsubmit="return regValidate()">
	...
	<input type="email" name="email_id" placeholder="Email-ID" id= "email" required/><br>
	
	<input type="text" name="full_name" placeholder="Full Name" id= "name" required><br>
	
	<input type="password" name="password" id="password" placeholder="Password" required><br>
	
	<input type="password" name="confirm_password" id="retry-password" placeholder="Confirm Password" required/><br>
	
	<input type="text" name="phone_no" placeholder="Phone Number" id= "phone" required/><br>
	
	<input type="text" name="address" placeholder="Address" id= "address" required/><br>
	
	<input type="text" name="zipcode" placeholder="Zipcode" id= "zipcode" required/><br>
